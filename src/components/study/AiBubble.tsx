...
/**
 * AI 小助手悬浮球：精灵球样式，点击打开对话面板。
 * 可拖拽：按住拖动到任意位置，松开后停留；位移 < 4px 视为点击。
  ...
  return (
    ...
    >
      <span className="ai-ball">
        <span className="ai-ball-top" />
        <span className="ai-ball-seam" />
        <span className="ai-ball-bottom" />
        <span className="ai-ball-button" />
      </span>
